...
include_once('../config.php');
    ...
    $sqlBlog = "SELECT * FROM blog ORDER BY id DESC limit 30";
    ...
    <div class="main-content">
            ...
            <main class="principal-painel">
                <div class="lista-usuarios">
                    <h2 class="title mb-5 text-center">Últimos Posts - <a class="btn btn-primary" href="blog_add.php"><i class="fas fa-plus-circle"></i> Adicionar Post</a></h2>
                    <table class="table table-usuarios bg-table">
                        ...
                        <tbody>
                            <?php
                                while($user_data = mysqli_fetch_assoc($resultBlog)){
                                    echo "<tr>";
                                    echo "<td>".$user_data['id']."</td>";
                                    echo "<td>".$user_data['titulo']."</td>";
                                    echo "<td>
                                    <a href='blog_delete.php?id=$user_data[id]' class='edit-user btn btn-sm btn-danger'><i class='fas fa-trash'></i></a>
                                    </td>";
                                }
                            ?>
                        </tbody>
