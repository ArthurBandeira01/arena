                ...
                <div class="lista-usuarios">
                    <div class="header-usuarios mt-3 d-flex flex-column flex-sm-row justify-content-around">
                        <div class="titulo-usuarios mt-3">
                            <h2 class="title mb-5 text-center"><i class="fas fa-user"></i> Usuários do sistema:</h2>
                        </div><!--titulo-usuarios-->
                        <div class="buscar-usuarios d-flex">
                            <input class="busca" type="text" placeholder="Nome do usuário...">
                            <button class="btn ms-1" type="button" name="buscarUser" id="buttonUser"><i class="fas fa-search"></i> Buscar</button>
                        </div><!--buscar-usuarios-->
                    </div><!--header-usuarios-->
                    <table class="table table-usuarios bg-table">
                        ...
                        <tbody>
                            <?php
                                while($user_data = mysqli_fetch_assoc($resultCPF)){
                                    echo "<tr>";
                                    ...
                                    echo "<td>
                                    <a href='../edit_user.php?id=$user_data[id]' class='edit-user btn btn-sm btn-primary'><i class='fas fa-pencil-alt'></i></a>
                                    <a href='deleteEdit.php?id=$user_data[id]' class='delete-user btn btn-sm btn-danger'><i class='fas fa-trash-alt'></i></a>
                                    </td>";
                                }
                            ?>
                        </tbody>
