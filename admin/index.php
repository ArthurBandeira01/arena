...
include_once('../config.php');
    ...
    $sqlCPF = "SELECT * FROM usuarios ORDER BY id ASC";
        ...
        <div class="logo-painel">
            <div class="logo-toggle">
                <a href="index.php" class="logo-link-toggle">
                    <img class="toggle-img" src="assets/images/logo/oficial.png" alt="Arena"
                    title="Arena">
                </a><!--logo-link-toggle-->
            </div><!--logo-toggle-->
            <a href="index.php" class="link-logo-painel">
                <img class="logo-painel-img" src="assets/images/logo/oficial.png" alt="Arena"
                title="Arena">
            </a><!--link-logo-painel-->
        </div><!--logo-->
    ...
    <div class="main-content">
            ...
            <main class="principal-painel">
                <div class="lista-usuarios">
                    <h2 class="title mb-5 text-center"><i class="fas fa-users"></i> Usuários do sistema - <?php echo $dataCot; ?></h2>
