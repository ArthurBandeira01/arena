...
include_once('../config.php');
    ...
    $sqlDepoimento = "SELECT * FROM depoimentos ORDER BY id DESC limit 20";
    ...
    <div class="main-content">
            ...
            <main class="principal-painel">
                <div class="lista-usuarios">
                    <h2 class="title mb-5 text-center"><i class="fas fa-users"></i> Depoimentos - <a class="btn btn-primary" href="depoimento_edit.php">Adicionar Depoimento</a></h2>
                    ...
                    <table class="table table-usuarios bg-table">
                        ...
                        <tbody>
                            <?php
                                while($user_data = mysqli_fetch_assoc($resultDepoimento)){
                                    echo "<tr>";
                                    echo "<td>".$user_data['id']."</td>";
                                    echo "<td>".$user_data['nome']."</td>";
                                    echo "<td>".$user_data['comentario']."</td>";
                                    echo "<td>
                                    <a href='delete_depoimento.php?id=$user_data[id]' class='delete-user btn btn-sm btn-danger'><i class='fas fa-trash-alt'></i></a>
                                    </td>";
                                }
                            ?>
                        </tbody>
