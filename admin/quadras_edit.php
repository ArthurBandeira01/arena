...
include_once('../config.php');
    ...
    $sqlQuadras = "SELECT * FROM quadras ORDER BY id DESC limit 25";
    ...
    <div class="main-content">
            ...
            <main class="principal-painel">
                <div class="lista-usuarios">
                    <h2 class="title mb-5 text-center"><i class="far fa-handshake"></i> Quadras - <a href="quadras_add.php" class="btn btn-primary">Adicionar Quadra</a></h2>
                    <table class="table table-usuarios bg-table">
                        ...
                        <tbody>
                            <?php
                                while($user_data = mysqli_fetch_assoc($resultQuadras)){
                                    echo "<tr>";
                                    echo "<td>".$user_data['id']."</td>";
                                    echo "<td>".$user_data['nome_quadra']."</td>";
                                    echo "<td>".$user_data['celular']."</td>";
                                    echo "<td>".$user_data['telefone']."</td>";
                                    echo "<td>
                                    <a href='quadras_delete.php?id=$user_data[id]' class='delete-user btn btn-sm btn-danger'><i class='fas fa-trash-alt'></i></a>
                                    </tr>";
                                }
                            ?>
                        </tbody>
