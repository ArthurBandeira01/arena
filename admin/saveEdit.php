<?php
    ...
    if(isset($_POST['update'])){
        ...
        $sqlUpdate = "UPDATE usuarios SET nome='$nomeCPF',email='$emailCPF',cpf='$cpf',endereco='$enderecoCPF',cidade='$cidadeCPF',
        estado='$estadoCPF',celular='$celularCPF',telefone='$telefoneCPF',senha='$passwordCPF' WHERE id = $id";
