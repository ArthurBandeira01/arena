...
include_once('../config.php');
    ...
    $sqlPatrocinio = "SELECT * FROM patrocinios ORDER BY id DESC limit 25";
    ...
    <div class="main-content">
            ...
            <main class="principal-painel">
                <div class="lista-usuarios">
                    <h2 class="title mb-5 text-center"><i class="far fa-handshake"></i> Patrocínios - <a href="patrocinios_add.php" class="btn btn-primary">Adicionar</a></h2>
                    <table class="table table-usuarios bg-table">
                        ...
                        <tbody>
                            <?php
                                while($user_data = mysqli_fetch_assoc($resultPatrocinio)){
                                    echo "<tr>";
                                    echo "<td>".$user_data['id']."</td>";
                                    echo "<td>".$user_data['patrocinio']."</td>";
                                    echo "<td>".$user_data['path_patrocinio']."</td>";
                                    echo "<td>
                                    <a href='patrocinios_delete.php?id=$user_data[id]' class='delete-user btn btn-sm btn-danger'><i class='fas fa-trash-alt'></i></a>
                                    </tr>";
                                }
                            ?>
                        </tbody>
